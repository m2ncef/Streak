...
export default (props) => {
  ...
  useEffect(() => {
    ...
    fetch(
      `https://api.themoviedb.org/3/tv/${props.id}?api_key=84120436235fe71398e95a662f44db8b`
    )
      .then((r) => r.json())
      .then((data) => {
        async function scrape() {
          ...
          if (!output.stream.playlist) {
            if (
              ...
              output.stream.qualities["1080"] &&
              output.stream.qualities["1080"].url
            ) {
              ...
              output.stream.qualities &&
              output.stream.qualities["360"] &&
              output.stream.qualities["360"].url
            ) {
